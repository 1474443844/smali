...
- Java-style nested `baksmali list <kind>` CLI commands and aliases, including formatter-backed reference output, quoted/escaped `list strings` output, and primary-dex selection for APK/JAR/ZIP input.
